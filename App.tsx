            ...
            {!lesson ? (
              ...
              <div className="space-y-8 sm:space-y-16 animate-fade-in">
                ...
                <div className="text-center py-8 sm:py-12 bg-white rounded-xl sm:rounded-2xl shadow-lg border border-brand-100 flex flex-col items-center gap-4 sm:gap-6 relative overflow-hidden">
                  <MsTrangLogo className="w-16 h-16 sm:w-20 sm:h-20 drop-shadow-lg" color="#8B1C24" />
      ...
      <footer className="bg-brand-900 text-white border-t-[10px] border-brand-800 pt-20 pb-10">
        <div className="max-w-[1400px] mx-auto px-6 text-center md:text-left">
          <div className="grid md:grid-cols-3 gap-12 items-start mb-16">
            ...
            <div className="space-y-6 text-center md:text-left">
              <h4 className="font-black text-highlight-400 text-xl uppercase tracking-[0.2em] border-b-2 border-white/10 pb-2 font-sans">Về Chúng Tôi</h4>
              <div className="bg-white/5 p-8 rounded-[2rem] border-2 border-white/10 shadow-xl backdrop-blur-sm"><p className="text-xl font-black italic text-white mb-3 leading-tight">"Xây nền từ móng, chinh phục đỉnh cao"</p><p className="text-brand-300 font-black text-base uppercase tracking-widest font-sans">Pallas – nơi tri thức được trao truyền, ước mơ được nuôi dưỡng và những thế hệ học sinh được chắp cánh vươn xa.</p></div>
            </div>
          </div>
